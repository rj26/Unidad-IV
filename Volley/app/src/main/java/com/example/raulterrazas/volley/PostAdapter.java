package com.example.raulterrazas.volley;
...
/**
 * Created by Raul Terrazas on 26/05/2016.
 */
public class PostAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textoDescripcion = (TextView) listItemView.findViewById(R.id.txtDesc);
        final ImageView imagenPost = (ImageView) listItemView.findViewById(R.id.imgPost);
